...
public class viewbook extends javax.swing.JFrame {
     ...
     */
    String[] title={"Book Id","Book Name","Author","Quantity","date","No of Issued"};
    ...
    public viewbook() {
        ...
        try{
            ...
            while(rs.next()){
                ...
                output[i][j++]=rs.getString("author");
                output[i][j++]=rs.getString("quantity");
                output[i][j++]=rs.getString("date");
                output[i][j++]=rs.getString("Issued");
                j=0;
                i++;
            }
